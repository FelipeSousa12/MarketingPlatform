...
<head>
    ...
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">
	  ...
	  <link rel="stylesheet" type="text/css" href="../css/style_relatorio_anunc.css">
    ...
    <section class="conteudo">
       ...
       <div class="caminho">
           <ul>
             ...
             <li id="li_caminho"><a href="../Telas/RelatorioAnunc.php" id="a_caminho">Relatórios</a></li>
           </ul>
       </div>
              ...
              <i class="far fa-file-pdf"></i>
                ...
                <div class="escolha-relatorio">
                  ...
                  <form action="../Relatorio/RelatorioAnunciantes.php" method="POST" target="_blank">
                    ...
                    <p><button type="submit" class="btn btn-success" style="margin-top: 10px;">GERAR RELATÓRIO</button></p>
                  </form>
